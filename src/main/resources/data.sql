...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Classic Denim Jacket', 'Timeless blue denim jacket, suitable for any occasion', 65.0, 'M', 6, 1);
...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Cropped Sweater', 'Cozy cropped sweater for a stylish winter look', 38.75, 'S', 5,  1);
...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Casual Shorts', 'Comfortable and casual shorts for warm days', 28.99, 'L', 4, 1);
...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Knit Hoodie', 'Knit hoodie with a unique texture, perfect for fall', 55.5, 'M', 3, 1);
...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Floral Dress', 'Elegant floral dress with a feminine touch', 68.25, 'S', 7, 1);
...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Graphic Print T-Shirt', 'Creative graphic print t-shirt with a modern design', 22.0, 'L', 8, 1);
...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Classic Blue Jeans', 'Timeless blue jeans for a versatile look', 50.75, 'M', 9, 1);
...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('A-Line Skirt', 'Chic A-line skirt for a sophisticated style', 38.5, 'XS', 10, 3);
...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Warm Winter Coat', 'Cozy winter coat to keep you warm in cold weather', 95.99, 'L', 11, 3);
...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Leather Biker Jacket', 'Classic leather biker jacket for edgy look', 120.0, 'M', 6, 3);
insert into vinted.clothe_images (clothe_id, images) values(11, 'jacket3.jpg');

INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Striped Sweater', 'Casual striped sweater for a cozy vibe', 32.5, 'S', 5, 3);
...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Cargo Shorts', 'Functional cargo shorts for outdoor activities', 34.99, 'L', 4, 3);
insert into vinted.clothe_images (clothe_id, images) values(13, 'shorts3.jpg');

INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Printed Hoodie', 'Hoodie with unique printed design, trendy style', 42.0, 'M', 3, 3);
...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Elegant Evening Dress', 'Elegant evening dress for special occasions', 85.0, 'S', 7, 3);
...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Vintage Graphic T-Shirt', 'Vintage-style graphic t-shirt for retro lovers', 18.5, 'L', 8, 3);
...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Distressed Jeans', 'Distressed jeans with a grunge touch', 48.75, 'M', 9, 3);
...
INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Floral Midi Skirt', 'Floral midi skirt with a flowy silhouette', 35.0, 'XS', 10, 3);
insert into vinted.clothe_images (clothe_id, images) values(18, 'skirt5.jpg');

INSERT INTO vinted.clothes (name, description, price, size, category_id, user_id)
VALUES ('Wool Blend Coat', 'Stylish wool blend coat for colder days', 78.99, 'L', 11, 3);
