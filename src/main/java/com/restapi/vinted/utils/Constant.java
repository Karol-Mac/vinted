...
public class Constant {
    ...
    public final static String NAME_VALIDATION_FAILED = "Name has to be at least 3 characters";
    public final static String DESCRIPTION_VALIDATION_FAILED = "Description has to be at least 10 characters";
    public final static String PRICE_VALIDATION_FAILED = "Price has to be positive";
